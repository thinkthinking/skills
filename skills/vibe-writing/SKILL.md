...
```text
<project-dir>/results/vibe-writing
```
...
```bash
mkdir -p <project-dir>/results/vibe-writing
```
...
2. Resolve `<project-dir>` and `<output-dir>`.
   ...
   - Use `<project-dir>/results/vibe-writing` for all writing artifacts generated by this skill.
...
current project's `results/vibe-writing` directory. Do not store article bodies
...
`results/vibe-writing`, follow it.
...
```bash
thinkthinking wechat convert results/vibe-writing/YYYY-MM-DD-slug-final.md \
  --output results/vibe-writing/YYYY-MM-DD-slug-wechat.html
```
...
```bash
thinkthinking wechat convert results/vibe-writing/YYYY-MM-DD-slug-final.md --copy
thinkthinking wechat convert results/vibe-writing/YYYY-MM-DD-slug-final.md --preview
```
...
```bash
thinkthinking wechat post results/vibe-writing/YYYY-MM-DD-slug-final.md \
...
```bash
thinkthinking wechat post results/vibe-writing/YYYY-MM-DD-slug-wechat.html \
  --title "文章标题" --author "作者名" --cover cover.jpg
```
